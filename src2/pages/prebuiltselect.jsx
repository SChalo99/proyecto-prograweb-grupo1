    ...
    return <div className="bg-dark">
        ...
        <div className="container" style={{ textAlign: "center" }}>
            ...
            <div className="mb-5" style={{ width: "50%", float: "right"}}>
                <button className="btn btn-light" style={{ width: "125px", marginRight: "15px" }} onClick={()=>{navigate("/proyecto/")}}>ATRÁS</button>
                <button className="btn btn-success" style={{ width: "125px", marginLeft: "15px" }} onClick={()=>{navigate("/proyecto/prebuilt")}}>SIGUIENTE</button>
            </div>
        </div>
